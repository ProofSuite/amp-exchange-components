...
import {macdAppearance, mouseEdgeAppearance} from "./indicatorSettings";
...
class CandleStickChartWithMACDIndicator extends React.Component {
    ...
    render() {
        const {
            type, data: initialData, expandedChard, width, ratio,
                ...
                >
...

                    {
                        ...
                        <Chart id={3} height={150}
                               ...
                               origin={(w, h) => [0, h - macd.height - (atr.active ? atr.height : 0) - (rsi.active ? rsi.height : 0) - (forceIndex.active ? forceIndex.height : 0)]}
                    ...
                    }
                    {
                        ...
                        <Chart id={4}
                               yExtents={[0, 100]}
                               height={rsi.height}
                               origin={(w, h) => [0, h - rsi.height - (atr.active ? atr.height : 0) - (forceIndex.active ? forceIndex.height : 0)]}
                               padding={{top: 10, bottom: 10}}
                        >
                            <XAxis axisAt="bottom" orient="bottom" showTicks={!atr.active && !forceIndex.active }
                                   stroke={theme.axis}
                                   tickStroke={theme.axis}
                                   fill={theme.axis}
                                   outerTickSize={0}
                    ...
                    {
                        forceIndex.active && expandedChard &&
