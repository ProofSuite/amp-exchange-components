...
import { sorter, boundDecimal } from "../utils/services";
            ...
            <div>
                ...
                <table className="pt-html-table pt-interactive pt-html-table-bordered">
                    ...
                    </thead>
                    {
                        this.props.loading &&
                        <tr>
                            <td style={{height: '400px'}} colSpan={8} rowSpan={8}>
                    ...
                    }
                    {
                        ...
                        {
                            !this.props.loading &&
                            filteredCoins.sort((a, b) => sorter(a, b, state.sortOrder, state.filterName)).sort((a,b) => b.starred - a.starred).map(function (coin, index) {
                                return (
                                    <tr key={index}>
                                        <td style={{width: '50px'}}>
